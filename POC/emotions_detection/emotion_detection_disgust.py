...
for emotion_dir in os.listdir(base_directory):
    ...
    print(emotion_path.lower() )
    if emotion_path.lower() != 'test/disgusted' :
        continue
    ...
    if os.path.isdir(emotion_path):
        ...
        for filename in os.listdir(emotion_path):
            if filename.endswith(".png") or filename.endswith(".jpeg") or filename.endswith(".jpg"):
                ...
                print(f" {filename} in {emotion_dir} is recognized as {emotion_text}.")
...
print(f"Accuracy for all : {sum_of_percentages:.2f/7.0}%")
